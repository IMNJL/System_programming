...
#### Здесь будут располагаться лабораторные работы по системному программированию на Си(с ассемблерной вставкой)
...
| [Laboratory work №4](https://github.com/IMNJL/System_programming/tree/main/threads)             | `100%` | **Threads**          | `5/10`     | `3/10`     |
